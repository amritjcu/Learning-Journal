...
### Learning Journal - Presentation Rehearsal Week

This week, I focused on preparing for our group presentation. We had a stand-up meeting to update each other on progress and make sure everyone was on track. We also did a tech check to ensure our equipment was working properly, and I tested my laptop, which had a few issues that we quickly fixed.

I did run-throughs of my part. The first was to get comfortable with the flow, the second to check the timing, and the third to improve my delivery. I noticed I was slightly over time and that my microphone picked up some background noise, so I adjusted both.

After each rehearsal, we gave feedback. We realized some parts were too rushed, and others were too slow, so we worked on tightening up the content and making the transitions smoother.

### Reflections:

### Strengths: I felt good about the content and the tech check helped avoid last-minute issues. The video recordings helped me see where I could improve.
### Challenges: Time management was tricky, and I had to adjust my content to fit the time. The microphone setup also needed tweaking.
### Areas to Improve: I want to work on engaging the audience more with eye contact and varying my tone. I also need to refine transitions between segments.
### Next Steps:

Finalize the slides and make sure they’re easy to read.
Practice more to improve pacing and avoid filler words.
Keep rehearsing with the team and give helpful feedback.
Overall, the rehearsals have been helpful in making me feel more confident. With a few more tweaks, I’m sure the presentation will be ready.
